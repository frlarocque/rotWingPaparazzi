 ...
 * @param _debug_3 
 */
static inline void pprzlink_msg_v2_send_AIRSPEED_WIND_ESTIMATOR_EKF(struct pprzlink_msg * msg, float *_u_est, float *_v_est, float *_w_est, float *_mu_x, float *_mu_y, float *_mu_z, float *_offset_x, float *_offset_y, float *_offset_z, float *_debug_1, float *_debug_2, float *_debug_3) {
  ...
  if (msg->trans->check_available_space(msg, _FD_ADDR, size)) {
    ...
    msg->trans->put_bytes(msg, _FD, DL_TYPE_FLOAT, DL_FORMAT_SCALAR, (void *) _mu_x, 4);
    msg->trans->put_bytes(msg, _FD, DL_TYPE_FLOAT, DL_FORMAT_SCALAR, (void *) _mu_y, 4);
    msg->trans->put_bytes(msg, _FD, DL_TYPE_FLOAT, DL_FORMAT_SCALAR, (void *) _mu_z, 4);
...
#define DOWNLINK_SEND_AIRSPEED_WIND_ESTIMATOR_EKF(_trans, _dev, u_est, v_est, w_est, mu_x, mu_y, mu_z, offset_x, offset_y, offset_z, debug_1, debug_2, debug_3) pprz_msg_send_AIRSPEED_WIND_ESTIMATOR_EKF(&((_trans).trans_tx), &((_dev).device), AC_ID, u_est, v_est, w_est, mu_x, mu_y, mu_z, offset_x, offset_y, offset_z, debug_1, debug_2, debug_3)
/**
 ...
 * @param _debug_3 
 */
static inline void pprz_msg_send_AIRSPEED_WIND_ESTIMATOR_EKF(struct transport_tx *trans, struct link_device *dev, uint8_t ac_id, float *_u_est, float *_v_est, float *_w_est, float *_mu_x, float *_mu_y, float *_mu_z, float *_offset_x, float *_offset_y, float *_offset_z, float *_debug_1, float *_debug_2, float *_debug_3) {
    ...
    msg.receiver_id = 0;
    msg.component_id = 0;
    pprzlink_msg_v2_send_AIRSPEED_WIND_ESTIMATOR_EKF(&msg,_u_est,_v_est,_w_est,_mu_x,_mu_y,_mu_z,_offset_x,_offset_y,_offset_z,_debug_1,_debug_2,_debug_3);
}
...
<message name="AIRSPEED_WIND_ESTIMATOR_EKF" id="199">
      ...
      <field name="mu_x"      type="float" unit="m/s"/>
      <field name="mu_y"      type="float" unit="m/s"/>
      <field name="mu_z"      type="float" unit="m/s"/>
...
#define DOWNLINK_SEND_AIRSPEED_WIND_ESTIMATOR_EKF(_trans, _dev, u_est, v_est, w_est, mu_x, mu_y, mu_z, offset_x, offset_y, offset_z, debug_1, debug_2, debug_3) {}
static inline void pprz_send_msg_AIRSPEED_WIND_ESTIMATOR_EKF(struct transport_tx *trans __attribute__((unused)), struct link_device *dev __attribute__((unused)), uint8_t ac_id __attribute__((unused)), float *_u_est __attribute__((unused)), float *_v_est __attribute__((unused)), float *_w_est __attribute__((unused)), float *_mu_x __attribute__((unused)), float *_mu_y __attribute__((unused)), float *_mu_z __attribute__((unused)), float *_offset_x __attribute__((unused)), float *_offset_y __attribute__((unused)), float *_offset_z __attribute__((unused)), float *_debug_1 __attribute__((unused)), float *_debug_2 __attribute__((unused)), float *_debug_3 __attribute__((unused))) {}
...
/** Getter for field mu_x in message AIRSPEED_WIND_ESTIMATOR_EKF
  *
  * @param _payload : a pointer to the AIRSPEED_WIND_ESTIMATOR_EKF message
  * @return 
  */
static inline float pprzlink_get_DL_AIRSPEED_WIND_ESTIMATOR_EKF_mu_x(uint8_t * _payload __attribute__((unused)))
{
    return _PPRZ_VAL_float(_payload, 16);
}


/** Getter for field mu_y in message AIRSPEED_WIND_ESTIMATOR_EKF
  *
  * @param _payload : a pointer to the AIRSPEED_WIND_ESTIMATOR_EKF message
  * @return 
  */
static inline float pprzlink_get_DL_AIRSPEED_WIND_ESTIMATOR_EKF_mu_y(uint8_t * _payload __attribute__((unused)))
{
    return _PPRZ_VAL_float(_payload, 20);
}


/** Getter for field mu_z in message AIRSPEED_WIND_ESTIMATOR_EKF
  *
  * @param _payload : a pointer to the AIRSPEED_WIND_ESTIMATOR_EKF message
  * @return 
  */
static inline float pprzlink_get_DL_AIRSPEED_WIND_ESTIMATOR_EKF_mu_z(uint8_t * _payload __attribute__((unused)))
{
...
#define DL_AIRSPEED_WIND_ESTIMATOR_EKF_mu_x(_payload) pprzlink_get_DL_AIRSPEED_WIND_ESTIMATOR_EKF_mu_x(_payload)
#define DL_AIRSPEED_WIND_ESTIMATOR_EKF_mu_y(_payload) pprzlink_get_DL_AIRSPEED_WIND_ESTIMATOR_EKF_mu_y(_payload)
#define DL_AIRSPEED_WIND_ESTIMATOR_EKF_mu_z(_payload) pprzlink_get_DL_AIRSPEED_WIND_ESTIMATOR_EKF_mu_z(_payload)
